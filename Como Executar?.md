...
Agora vamos baixar o projeto direto do GitHub.

No terminal, execute:

git clone https://github.com/rmythzl/task-manager-python.git

📦 O Git irá copiar todos os arquivos do projeto para sua máquina.

---

## 📂 Passo 2 — Entrar na pasta do projeto

Após o download, acesse a pasta criada:

cd task-manager-python

Você agora estará dentro do projeto.

---

## 📁 Passo 3 — Acessar o código-fonte

O código principal fica dentro da pasta **src**.

Entre nela com o comando:

cd src

📄 Dentro dessa pasta você encontrará o arquivo:
...
## 🖥️ Como usar o sistema (na prática)
...
O programa será encerrado com segurança.
...
🎓 Projeto educacional patrocinado por:  
**Study Fy** — Estudando de forma mais inteligente 🚀

---

## 👨‍💻 Autor

Desenvolvido por **Rian Gabriel (rmythzl)**  
